...
describe('CandlePatternDetector', () => {
  ...
  describe('Pattern Validation', () => {
    it('should validate OHLC values correctly', () => {
      ...
      const patterns = CandlePatternDetector.detectPatterns([invalidCandle]);
    ...
    it('should handle edge cases gracefully', () => {
      // Empty array
      expect(CandlePatternDetector.detectPatterns([])).toHaveLength(0);
      
      // Single candle (some patterns need multiple candles)
      const singleCandle = createCandle(100, 105, 95, 102);
      const patterns = CandlePatternDetector.detectPatterns([singleCandle]);
